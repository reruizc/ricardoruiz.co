...
(function(){
  ...
  Object.assign(window,{esc,fmt,norm,tCase,depNice,lift,call,openModal,closeModal,
    updateNavAuth,logOutPage,autoresDe,autoresCorto});
  updateNavAuth();
})();
