...
MANUAL = {
    ...
    # Ampliación jul-2026 — prolíficos que no caen en el join (pre-2014 o
    # fragmentación de nombre: 2 tokens no subset-matchean). Afiliación de alta
    # confianza durante su periodo legislativo principal. Se supera cuando la
    # RNEC entregue los GCS_*CON pre-2014. Switchers/ambiguos deliberadamente
    # fuera (Benedetti, Moreno de Caro, Vélez Uribe, Clopatofsky, Araújo…).
    'CAMILO SANCHEZ ORTEGA': 'PARTIDO LIBERAL COLOMBIANO',
    'CAMILO SANCHEZ': 'PARTIDO LIBERAL COLOMBIANO',
    'NADIA BLEL SCAFF': 'PARTIDO CONSERVADOR COLOMBIANO',
    'NADIA GEORGETTE BLEL SCAFF': 'PARTIDO CONSERVADOR COLOMBIANO',
    'EMMA CLAUDIA CASTELLANOS': 'MIRA',
    'MANUEL VIRGUEZ': 'MIRA',
    'CARLOS ALBERTO BAENA LOPEZ': 'MIRA',
    'DILIAN FRANCISCA TORO TORRES': 'PARTIDO DE LA U',
    'MARITZA MARTINEZ': 'PARTIDO DE LA U',
    'HERNAN ANDRADE': 'PARTIDO CONSERVADOR COLOMBIANO',
    'EFRAIN CEPEDA': 'PARTIDO CONSERVADOR COLOMBIANO',
    'ROBERTO GERLEIN': 'PARTIDO CONSERVADOR COLOMBIANO',
    'ARMANDO ANTONIO ZABARAIN DE ARCE': 'PARTIDO CONSERVADOR COLOMBIANO',
    'GUSTAVO FRANCISCO PETRO URREGO': 'PACTO HISTÓRICO',
    'GLORIA INES RAMIREZ': 'POLO DEMOCRÁTICO ALTERNATIVO',
    ...
    'CLAUDIA BLUM': 'CAMBIO RADICAL',
    'JAVIER CACERES LEAL': 'CAMBIO RADICAL',
    'JOHN MILTON RODRIGUEZ GONZALEZ': 'COLOMBIA JUSTA LIBRES',
    'MILTON RODRIGUEZ': 'COLOMBIA JUSTA LIBRES',
    'EDGAR ENRIQUE PALACIO MIZRAHI': 'COLOMBIA JUSTA LIBRES',
}
