#!/usr/bin/env python3
"""
Propuesta comercial · Caudal para Cauce — 7 de septiembre de 2026.
...
Salida: caudalxcauce/Cauce/Propuesta-Caudal-Cauce-2026-09-07.pdf (carpeta
...
ROOT = base.ROOT
OUT = os.path.join(ROOT, "caudalxcauce", "Cauce", "Propuesta-Caudal-Cauce-2026-09-07.pdf")
...
<div class="top">
  ...
  <div class="meta">Propuesta comercial · Caudal para Cauce<br>Borrador 1 · 7 de septiembre de 2026</div>
</div>
"""
...
<div class="hero">
  ...
  <p class="lead">Primer borrador de la estructura comercial: el diferencial que se puede demostrar
  en tres minutos, el producto que ya está listo para poner frente a un cliente, lo que todavía no,
  y los tres precios — el que Cauce le paga a Caudal, el de la plataforma sola y el de la plataforma
  con analista.</p>
...
<div class="item resumen">
  ...
  <h2>El producto está listo; el brief automático no. Y el precio no lo fija el costo, lo fija la capacidad de analista.</h2>
  ...
  <p>Servir la plataforma cuesta <b>$2.200 pesos por cliente al mes</b>. El brief personalizado cada
  cuatro días, escrito con el modelo de mayor calidad del mercado, sube ese costo a <b>$11.000</b>.
  Con costos así, el precio es una decisión comercial, no una cuenta: lo que de verdad limita cuántos
  clientes se pueden atender es cuántas horas de analista hay para revisar lo que el motor escribe.</p>
...
<div class="item">
  ...
  posición en que lo agendan. En comisión de Cámara, el primero del día llega al <b>53%</b> y el
  cuarto al sexto caen al <b>21%</b>. En plenaria de Senado la curva se degrada más rápido: de
  <b>69,6%</b> el primero a <b>19,9%</b> el sexto. La mediana de un proyecto son siete agendamientos;
  hay uno agendado ochenta veces.</p>
  <p>A eso se suman <b>455.000 votos nominales</b> (Cámara 2014-2026, Senado 2017-2026) clasificados
  en 16 tipos de votación. La diferencia importa: un representante puede salir con «40 Sí y 36 No» en
...
<div class="item">
  ...
  <table class="d">
    ...
    <tr><td>Histórico</td><td class="si">1990-2026 · 13.660 PL</td><td class="q">desde 2024</td><td class="q">parcial</td></tr>
    ...
    <tr><td>Voto nominal por tipo</td><td class="si">455.000 votos</td><td class="no">no</td><td class="no">no</td></tr>
    <tr><td>Contratación · SECOP</td><td class="si">5,9M contratos</td><td class="no">no</td><td class="no">no</td></tr>
    <tr><td>Reguladores</td><td class="q">12 fuentes · 61.146 actos</td><td class="q">sí</td><td class="q">parcial</td></tr>
...
<div class="item ok">
  ...
  <ul class="t">
    <li><b>Ocho pilares vivos:</b> Congreso · Regulatorio (12 fuentes, 61.146 actos) · Ejecutivo
    (10.193 decretos) · Contratación (5,9M contratos y 9M procesos de SECOP) · Medios (~250 medios) ·
    Gacetas (32.585, de las cuales 15.964 con texto buscable) · Voceros (94 entidades) · Control.</li>
...
<div class="item neg">
  <div class="num">05 · Lo que NO está listo</div>
  <h2>El brief cada cuatro días hoy se escribe a mano</h2>
  <p>Los briefs que Cauce ya conoce —el de Binance y el de la semana pasada— no salen de un botón:
  son documentos curados, con el motor haciendo el barrido y una persona escribiendo. Automatizar eso
  para varias cuentas es un proyecto de ingeniería de <b>dos a tres semanas</b>, no un cambio de
  configuración. Es el hueco más grande entre esta propuesta y la realidad, y conviene que Cauce lo
  sepa antes de prometerle una cadencia a un cliente.</p>
  <p>Tampoco tenemos, y no estarán en el piloto: transcripción de sesiones en vivo, alertas por
  WhatsApp, aplicación móvil ni cobertura fuera de Colombia.</p>
  <div class="porque"><span class="et">Lo que sí se puede prometer hoy</span>
  Un brief cada cuatro días <b>asistido</b>: el motor arma el borrador con el barrido de los ocho
  pilares y una persona lo cierra. Es exactamente el modo en que se produjeron los dos que ya
  vieron, y sostiene sin problema entre tres y ocho cuentas.</div>
</div>
...
<div class="item urg">
  ...
  <table class="d">
    ...
    <tr><td>Motor del brief</td><td class="q">Del barrido al borrador redactado, sin escribir el HTML a mano cada vez.</td><td>2-3 semanas</td></tr>
...
<div class="item plata">
  ...
  <h2>Servir un cliente cuesta entre 2.200 y 11.000 pesos al mes</h2>
  <table class="p">
    <tr><th>Concepto</th><th>Cálculo</th><th>COP/mes</th></tr>
    <tr><td>Infraestructura fija</td><td class="q">35,5 GB en S3, funciones, proxy, correo — no se mueve entre 5 y 500 cuentas</td><td>100.000</td></tr>
    <tr><td>Brief personalizado</td><td class="q">7,6 briefs/mes · 66.000 tokens de entrada y 18.000 de salida, con caché y envío por lotes</td><td>11.000 <span class="q">/ cuenta</span></td></tr>
  ...
  El costo variable es despreciable: diez cuentas cuestan <b>210.000 pesos al mes</b> de servir. El
  costo real de Caudal es el mantenimiento, que existe haya una cuenta o cincuenta. Por eso el precio
...
<div class="item plata">
  ...
  cae al sexto mes. El piso técnico puro —no perder plata— serían 100.000 pesos más 11.000 por
...
<div class="item">
  ...
  <table class="d">
    ...
    <tr><td>Semanas 1-3</td><td class="q">Cerrar los tres huecos del punto 06. Cauce escoge tres cuentas piloto y define sus perfiles de vigiladas y temas.</td></tr>
    <tr><td>Semanas 4-12</td><td class="q">Piloto en marcha: brief cada cuatro días a las tres cuentas, alertas activas, revisión conjunta cada quince días de qué se leyó y qué se ignoró.</td></tr>
  ...
  números deciden a cuántas cuentas se puede escalar y en cuánto.</div>
</div>

<div class="foot">
  <b>Cifras.</b> Los costos de infraestructura y de modelo están medidos: 35,5 GB reales en
  almacenamiento, un barrido semanal de 22.101 caracteres y las tarifas publicadas de Anthropic y
  DeepSeek al 7 de septiembre de 2026. Se toma una tasa de 4.000 pesos por dólar.<br>
