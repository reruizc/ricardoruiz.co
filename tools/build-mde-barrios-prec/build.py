...
<p class="lead">Medellín votó <b>Abelardo __AB__ %</b> y <b>Cepeda __CE__ %</b> en primera vuelta, con Fajardo (__SF__ %) y Paloma (__PA__ %) más atrás. Es la ciudad más Abelardo del país: cruzando el preconteo por mesa con la cartografía de barrios, de los <b>__DIRECT__ barrios con dato directo Abelardo ganó __WIN_AB__ y Cepeda __WIN_CE__</b>. El azul cubre casi todo el valle; el rojo de Cepeda aparece en focos del centro, Manrique, Popular y la ladera nororiental. Pasa el cursor sobre cualquier barrio para ver su resultado.</p>
