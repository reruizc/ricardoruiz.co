...
window.BRUJULA = {
  ...
  candidatos: [
    { id:'camilo', nombre:'Camilo Pérez', nombreLargo:'Camilo Pérez López Moreira', partido:'ANR – Partido Colorado', lista:'1', color:'#c8102e', foto:false,
    ...
    { id:'soledad', nombre:'Soledad Núñez', nombreLargo:'Soledad Núñez Méndez', partido:'Alianza Juntos por Asunción', lista:'4', color:'#1f5fbf', foto:false,
    ...
    { id:'rodri', nombre:'Rodri Franco', nombreLargo:'Rodrigo Francisco Franco Arriola', partido:'Partido Demócrata Cristiano', lista:'6', color:'#0e7c4a', foto:false,
    ...
    { id:'arlene', nombre:'Arlene Aquino', nombreLargo:'Edith Arlene Aquino Morel', partido:'Partido Patria Soñada', lista:'300', color:'#e07b1a', foto:false,
